...
export const ALL_FOOD_INFO_FILES = [
    ...
    "grandma-shortys-jewish-coffee-cake",
    "grandmas-thanksgiving-dressing.json",
    "grandmoms-cucumber-sandwiches.json",
    "grandmoms-strawberry-cake.json",
    "great-great-grandma-barnes-rhubarb-pie",
    "great-great-uncle-charles-ginger-cookies",
    "honey-chicken.json",
    ...
    "taco-salad.json",
    "tofu-stirfry.json",
    "tts-chicken-pot-pie-in-a-bowl",
    "tts-garden-spaghetti",
    "tts-turkey-chili",
    "vegan-chili.json",
    "zuchini-boats.json",
]
