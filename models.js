...
export const ALL_FOOD_INFO_FILES = [
    ...
    "dads-sausage-balls.json",
    "dilly-ranch-cheez-its.json",
    "easy-taco-soup.json",
    "eggroll-in-a-bowl.json",
    "grandma-shortys-jewish-coffee-cake.json",
    "grandma-shortys-split-pea-soup.json",
    "grandma-johnsons-chocolate-icing.json",
    "grandma-johnsons-fried-rice.json",
    "grandma-johnsons-sour-cream-chocolate-cake.json",
    "grandmas-thanksgiving-dressing.json",
    "grandmoms-cucumber-sandwiches.json",
    "grandmoms-spinach-balls.json",
